...
namespace ApexCharts
{
    ...
    /// </remarks>
    public class DynamicApexPointSeries<TItem> : DynamicApexBaseSeries<TItem>, IApexSeries<TItem> where TItem : class
    {
        /// <summary>
        ...
        /// </summary>
        public Func<DataPoint<TItem>, object> OrderBy { get; set; }

        /// <summary>
        /// Expression to determine the inverse ordering of X-Values in the series
        /// </summary>
        public Func<DataPoint<TItem>, object> OrderByDescending { get; set; }
        ...
        /// </summary>
        public Action<DataPoint<TItem>> DataPointMutator { get; set; }
